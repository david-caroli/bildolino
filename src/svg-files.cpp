...
void initSvg(std::fstream &outFile, int height, int width, bool blackBackground, int lineOpacity, int lineThickness){
	outFile << "<svg xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" width = \"" << width << "\" height = \"" << height << "\" style = \"background:" << (blackBackground ? "black":"white") << "\">\n\t<defs>\n\t\t<style type=\"text/css\"><![CDATA[\n\t\t\tline{\n\t\t\t\tstroke-width:"<< lineThickness <<" ;\n\t\t\t\tstroke-opacity:"<< (lineOpacity/255) <<" ;\n\t\t\t}\n\t\t]]></style>\n\t</defs>\n";
}
